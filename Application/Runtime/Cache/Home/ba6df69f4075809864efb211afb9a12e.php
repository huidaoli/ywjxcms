          ...
          <form action="/index.php/Home/Purchase/addItem" id="itemForm">
              ...
              <div class="txt-fld">
                  ...
                  <select  id="product_id" name="product_id" class="select">
                      <?php if(is_array($products)): foreach($products as $key=>$product): ?><option value="<?php echo ($product["id"]); ?>" data-unit="<?php echo ($product["spec"]); ?>" ><?php echo ($product["name"]); ?> </option><?php endforeach; endif; ?>
                  </select>
